...
export class RoleGuard implements CanActivate {
    ...
    async canActivate(context: ExecutionContext): Promise<boolean> {
        ...
        const allowAnyRole = this.reflector.get<boolean>(META_ALLOW_ANY_ROLE, context.getHandler());
        ...
        if (!accessTokenJWT) {
            ...
            throw new UnauthorizedException("Are you sure AuthGuard is first in the chain?");
        }
