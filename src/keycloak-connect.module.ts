...
export class KeycloakConnectModule {
    ...
    public static registerAsync(opts: KeycloakConnectModuleAsyncOptions): DynamicModule {
    ...
    private static createConnectProviders(options: KeycloakConnectModuleAsyncOptions): Provider {
    ...
    private static createConnectOptionsProvider(options: KeycloakConnectModuleAsyncOptions): Provider {
